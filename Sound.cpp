...
bool Sound::Initialize(HWND hwnd, char* fileName, bool isLoop)
{
	bool result;
...
bool Sound::PlayWaveFile(bool isLoop)
{
	HRESULT result;
	...
	if (isLoop)		result = m_secondaryBuffer1->Play(0, 0, DSBPLAY_LOOPING);
	else			result = m_secondaryBuffer1->Play(0, 0, 0);
